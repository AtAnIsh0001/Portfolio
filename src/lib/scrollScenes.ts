 ...
 */
// The particle beat's content is physically staged at PARTICLES_STAGE_X (see
// HomeCanvasExperience) so the camera dollies sideways to arrive at it — the two
// beats' content never overlaps in space, no opacity-crossfade hacks needed.
